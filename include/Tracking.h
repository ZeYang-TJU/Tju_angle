...
public:
    ...
    bool ParseiGPSParamFile(cv::FileStorage &fSettings);
    ...
    cv::Mat GrabImageMonocular(const cv::Mat &im, const double &timestamp, string filename ,vector<cv::Point2f> simulationCurrentFrameKeyPoint, cv::Mat simulationCurrentFrameDescriptor);
...
protected:
    ...
    ORB_SLAM3::iGPS::Direction* iGPSDirection = NULL;
