...
void EdgeSE3ProjectXYZTd::linearizeOplus()
{
    ...
    _jacobianOplus[0] =  projectJac * T.rotation().toRotationMatrix();
    ...
    _jacobianOplus[1] = projectJac * SE3deriv;

    Eigen::Vector2d speed(_speed.x,_speed.y);
    _jacobianOplus[2] = -speed;
}
